// app/companies/of-whisky-atelier/page.tsx — v1.0 — 15/06/2026

import Link from "next/link";

export default function OFWhiskyAtelierCompanyPage() {
  return (
    <main className="min-h-screen bg-black px-8 py-20 text-white">
      <div className="mx-auto max-w-6xl">
        ...
        <h1 className="mt-6 text-6xl font-bold">OF Whisky Atelier Ltd</h1>

        <p className="mt-6 max-w-3xl text-xl leading-relaxed text-zinc-400">
          Certified whisky atelier profile for OF Whisky Atelier Ltd, focused on
          limited edition whisky collections, verified maturation stories,
          luxury positioning and E.L.Y.A.S-A.I. certified product identity.
        </p>

        <div className="mt-10 flex flex-wrap gap-3">
          <Badge>Certified Producer</Badge>
          <Badge>Whisky Atelier</Badge>
          <Badge>Luxury Spirits</Badge>
          <Badge>E.L.Y.A.S-A.I. Registered</Badge>
        </div>

        <section className="mt-16 grid gap-6 md:grid-cols-3">
          <Card title="Company Status" value="REGISTERED" />
        ...
        <section className="mt-16 rounded-3xl border border-pink-300/20 bg-white/5 p-8">
          ...
          <div className="mt-8 grid gap-6 md:grid-cols-2">
            <Info label="Company" value="OF Whisky Atelier Ltd" />
            <Info label="Role" value="Certified Producer" />
            <Info label="Sector" value="Premium Whisky & Spirits" />
            <Info label="Status" value="Registered" />
            <Info label="Certification Layer" value="E.L.Y.A.S-A.I." />
            <Info
              label="Product Scope"
              value="Whisky casks, limited editions and certified maturation stories"
            />
          </div>
        </section>
        ...
        <section className="mt-16 rounded-3xl border border-pink-300/20 bg-white/5 p-8">
          ...
          <div className="mt-8 grid gap-6 md:grid-cols-3">
            <Product name="Quadriga Cask" status="Concept" />
            <Product name="Trilogy Cask" status="Concept" />
            <Product name="Limited Whisky Atelier Releases" status="Planned" />
          </div>
        </section>
